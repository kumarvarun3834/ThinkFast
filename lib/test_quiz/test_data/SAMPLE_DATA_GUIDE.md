...
| `isAiGenerated`         | Boolean | No       | `true` if generated by AI (Default: false).                         |
| `examTag`               | String  | No       | Target competitive exam name (e.g. "NEET 2025").                    |
...
| `explanation` | String | No         | Detailed solution shown in Review Mode (Aliases: `description`).|
  ...
  "questions": [
    {
      ...
      "type": "Single Choice",
      "subject": "General",
      "explanation": "Scattering of light makes the sky appear blue."
    }
  ]
}
```
  ...
  "questions": [
    {
      ...
      "wrong": -50,
      "timer": 180,
      "explanation": "High stakes, high time limit."
    },
    {
