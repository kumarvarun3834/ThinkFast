...
class OptionButton extends StatelessWidget {
  ...
  OptionButton(this.opt, this.onPressed, this.quizResult, {super.key});

  final String opt;
  final Map<String, Object> quizResult;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: OutlinedButton.icon(
        onPressed: () {
          List<String> selectionList = (quizResult["selection"] as List)
              .cast<String>();
